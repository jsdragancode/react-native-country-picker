...
For more complete example open [App.tsx](https://github.com/echoLive/react-native-country-picker/master/App.tsx)
...
- `countryCode`: [CountryCode](https://github.com/echoLive/react-native-country-picker/blob/master/src/types.ts#L252)
- `region?`:[Region](https://github.com/echoLive/react-native-country-picker/blob/master/src/types.ts#L272)
- `subregion?`: [Subregion](https://github.com/echoLive/react-native-country-picker/blob/master/src/types.ts#L282)
- `countryCodes?`: [CountryCode](https://github.com/echoLive/react-native-country-picker/blob/master/src/types.ts#L254)
- `theme?`: [Theme](https://github.com/echoLive/react-native-country-picker/blob/7611d34fa35744dbec3fbcdd9b4401494b1ba8c4/src/CountryTheme.ts#L5)
- `translation?`: [TranslationLanguageCode](https://github.com/echoLive/react-native-country-picker/blob/master/src/types.ts#L309)
...
- `renderFlagButton?`(props: (FlagButton['props'])): ReactNode ([FlagButton props](https://github.com/echoLive/react-native-country-picker/blob/master/src/FlagButton.tsx#L73))
...
- `onSelect`(country: Country): void ([Country](https://github.com/echoLive/react-native-country-picker/blob/master/src/types.ts#L263))
- `onOpen`(): void
- `onClose`(): void
...
- `preferredCountries`: [CountryCode](https://github.com/echoLive/react-native-country-picker/blob/master/src/types.ts#L254) preferred countries they appear first (`withAlphaFilter` must be false)
...
[MIT](https://github.com/echoLive/react-native-country-picker/blob/master/LICENSE.md)
